//Adobe bundle - global consent - v1.2
            ...
            */
            ...
            document.addEventListener && document.addEventListener(adobe.target.event.REQUEST_FAILED, function (event) {
                ...
                var timeoutObj = {
                    ...
                    typeof JSON === "object" && JSON.stringify && tt_setCookie("mboxtimeouts", JSON.stringify(ttTimeouts), "../../../index.html", "dell.com", true);
                }
            });
...
DELL.tnt.country=window.geoCountry||DELL.tnt.country;var gpcValue=!!navigator.globalPrivacyControl,gpcStates=["ca"];(-1===gpcStates.indexOf(window.geoState)||!1===gpcValue)&&-1<DELL.tnt.supportedCountries.indexOf(DELL.tnt.country)&&(DELL.tnt.cookieConsent=getCookieConsent(),DELL.tnt.cookieConsent.match(/m/)&&fireadobetarget());